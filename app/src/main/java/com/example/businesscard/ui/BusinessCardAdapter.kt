...
class BusinessCardAdapter :
    ...
    inner class ViewHolder(
        ...
        fun bind(item: BusinessCard) {
            binding.mtvName.text = item.name
            binding.mtvPhone.text = item.phone
            binding.mtvEmail.text = item.email
            binding.mtvCompany.text = item.company
            binding.mcvCard.setCardBackgroundColor(Color.parseColor(item.background))
